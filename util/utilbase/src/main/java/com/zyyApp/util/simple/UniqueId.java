...
public class UniqueId {
    // 位与运算标签;
    private static final long SIGN_A = 255L;            // 数据段A 运算标签; 8位数据对应的 十进制数字
    ...
    private static final long SIGN_D = 8191L;           // 数据段D 运算标签; 13位数据对应的 十进制数字

    private static final int  POS_A  = 8;               // 数据段A 所占位数;
    private static final int  POS_B  = 30;              // 数据段B 所占位数;
    private static final int  POS_C  = 12;              // 数据段C 所占位数;
    private static final int  POS_D  = 14;              // 数据段D 所占位数;
     ...
     * 2.线程安全;
     *
     * 数据结构说明: {C-12位}{D-14位}{A-8位}{B-30位}  --- 共64位
